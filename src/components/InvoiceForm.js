...
class InvoiceForm extends React.Component {
  ...
  handleCalculateTotal() {
    ...
    this.setState({ subTotal: subTotal.toFixed(2) }, () => {
      const taxAmount = parseFloat(
        (subTotal * (this.state.taxRate / 100)).toFixed(2)
      );
      const discountAmount = parseFloat(
        (subTotal * (this.state.discountRate / 100)).toFixed(2)
      );
      const total = parseFloat(subTotal - discountAmount + taxAmount).toFixed(
        2
      );
  ...
  editField = (event) => {
    this.setState({
      ...
      this.handleCalculateTotal(); // Update totals after editing any field
    });
  };
              ...
              <Row className="mb-5">
                <Col>
                  ...
                  <Form.Control
                    ...
                    onChange={this.editField} // Ensure this calls editField
                  />
                </Col>
              </Row>
              <InvoiceItem
